        ...
        >
          ...
          <form style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div className='IDredondear' style={{ marginBottom: '10px', textAlign: 'center' }}>
              <input type="text" placeholder="Nombre de Usuario" style={{ width: '100%', padding: '10px', borderRadius: '10px', border: '1px solid #ccc', textAlign: 'center' }} />
            </div>

            <div className='IDredondear' style={{ marginBottom: '10px', textAlign: 'center' }}>
              <input type="text" placeholder="Correo Electrónico" style={{ width: '100%', padding: '10px', borderRadius: '10px', border: '1px solid #ccc', textAlign: 'center' }} />
            </div>

            <div className='IDredondear' style={{ marginBottom: '10px', textAlign: 'center' }}>
              <input type="password" placeholder="Contraseña" style={{ width: '100%', padding: '10px', borderRadius: '10px', border: '1px solid #ccc', textAlign: 'center' }} />
            </div>
